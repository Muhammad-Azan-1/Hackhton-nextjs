...
const Hero = () => {
  return (
    <>
      <div className="relative w-full pt-[40px] sm:pt-[60px] lg:pt-0 pb-[20px] lg:pb-0 h-auto lg:h-[470px] xl:h-[550px] min2:h-[650px] min1:h-[750px] bg-[#F2F0FF] flex px-6 lg:pr-6">
        <div className=" h-auto  absolute top-0 left-[5px]  lg:left-[0px] xl:left-[10px] min2:left-[10px] min1:left-[-2px]">
          <Image
